...
inline void pack(pack_t&, const string&,MinskyExclude&) {}
inline void unpack(pack_t&, const string&,MinskyExclude&) {}
inline void xml_pack(xml_pack_t&, const string&,MinskyExclude&) {}
inline void xml_unpack(xml_unpack_t&, const string&,MinskyExclude&) {}

#ifdef _CLASSDESC
#pragma omit pack MinskyExclude
#pragma omit unpack MinskyExclude
#pragma omit xml_pack MinskyExclude
#pragma omit xml_unpack MinskyExclude
#endif
...
#ifdef _CLASSDESC
#pragma omit pack MinskyMatrix
#pragma omit unpack MinskyMatrix
#pragma omit xml_pack MinskyMatrix
#pragma omit xml_unpack MinskyMatrix
#endif
...
#ifdef _CLASSDESC
#pragma omit pack GetterSetter
#pragma omit unpack GetterSetter
#pragma omit xml_pack GetterSetter
#pragma omit xml_unpack GetterSetter
#pragma omit pack GetterSetterPtr
#pragma omit unpack GetterSetterPtr
#pragma omit xml_pack GetterSetterPtr
#pragma omit xml_unpack GetterSetterPtr
#endif
template <class K, class T> 
void pack(classdesc::pack_t&,const string&,GetterSetter<K,T>&) {}
template <class K, class T> 
void unpack(classdesc::unpack_t&,const string&,GetterSetter<K,T>&) {}
template <class K, class T> 
void xml_pack(classdesc::xml_pack_t&,const string&,GetterSetter<K,T>&) {}
template <class K, class T> 
void xml_unpack(classdesc::xml_unpack_t&,const string&,GetterSetter<K,T>&) {}
template <class K, class T> 
void pack(classdesc::pack_t&,const string&,GetterSetterPtr<K,T>&) {}
template <class K, class T> 
void unpack(classdesc::unpack_t&,const string&,GetterSetterPtr<K,T>&) {}
template <class K, class T> 
void xml_pack(classdesc::xml_pack_t&,const string&,GetterSetterPtr<K,T>&) {}
template <class K, class T> 
void xml_unpack(classdesc::xml_unpack_t&,const string&,GetterSetterPtr<K,T>&) {}

// a place to put helper classes to manage XML evolution
namespace xml_conversions
{
  // convert old style Minsky variables into VariablePtrs
  class Variable: public VariableBase
  {
    VariableType::Type m_type;

    // the following virtual overrides aren't used, so just have dummy
    // implementations
    Type type() const {return m_type;}
    int numPorts() const {return 0;}
    Variable* clone() const {return NULL;}
    void pack(pack_t&) {}
