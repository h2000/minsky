...
#ifdef _CLASSDESC
#pragma omit pack EvalOp
#pragma omit unpack EvalOp 
#pragma omit xml_pack EvalOp
#pragma omit xml_unpack EvalOp
#endif

inline void pack(pack_t&,const string&,classdesc::ref<urand>&) {}
inline void unpack(pack_t&,const string&,classdesc::ref<urand>&) {}
inline void xml_pack(xml_pack_t&,const string&,classdesc::ref<urand>&) {}
inline void xml_unpack(xml_unpack_t&,const string&,classdesc::ref<urand>&) {}

// for TCL interfacing
inline std::ostream& operator<<(std::ostream& x, const vector<int>& y)
{
